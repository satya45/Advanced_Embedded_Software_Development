...
#define GPIO50  "/sys/class/gpio/gpio50/direction"
#define GPIO51  "/sys/class/gpio/gpio51/direction" //for chip enable
...
#define GPIO50_V  "/sys/class/gpio/gpio50/value"
#define GPIO51_V  "/sys/class/gpio/gpio51/value"

#define GPIO60_E  "/sys/class/gpio/gpio60/edge"
#define GPIO50_E  "/sys/class/gpio/gpio50/edge"
